...
enum {
  ...
  KG_BBISHOP  = KG_WGOLD    + 81,
  KG_WBISHOP  = KG_BBISHOP  + 81,
  KG_BHORSE   = KG_WBISHOP  + 81,
  KG_WHORSE   = KG_BHORSE   + 81,
  KG_BROOK    = KG_WHORSE   + 81,
  KG_WROOK    = KG_BROOK    + 81,
  KG_BDRAGON  = KG_WROOK    + 81,
  KG_WDRAGON  = KG_BDRAGON  + 81,
  KG_MAX      = KG_WDRAGON  + 81,
