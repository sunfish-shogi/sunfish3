...
private:
  static CONSTEXPR_CONST int ValueInf = 1U << (KeyLength - 1);
  static CONSTEXPR_CONST uint64_t ValueMask = (uint64_t)((1U << KeyLength) - 1U);
  static CONSTEXPR_CONST uint64_t HashMask = ~ValueMask;
